...
public class State
{
  ...
  /* Generally in a generic class such as State, you do not specify the parameters below in such specific manner, 
   * usually you should put these values in subclasses that will inherit from the State class. 
  */
  float visDist = 10.0f;
